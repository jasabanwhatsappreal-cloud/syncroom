...
async function fetchDrowify(path, options = {}, timeoutMs = 20000) {
...
export function drowifyGet(path, timeoutMs) {
  return fetchDrowify(path, {}, timeoutMs)
}

export function drowifyPost(path, body, timeoutMs) {
  return fetchDrowify(
    path,
    {
      method: 'POST',
