...
export default function useRoom(code, create) {
  ...
  const handleTrackChange = useCallback(
    ...
    [loadTrack, prewarmTrack, preloadTrack, updateState]
  )
...
setStatus('ready')
    ...
    [requestTrackLoad, prewarmTrack, preloadTrack]
  )
      ...
      const fetchInitialState = async () => {
        ...
        try {
          ...
          if (err) {
            ...
            // fall back to the host's ROOM_STATE broadcast below.
            st = null
          } else {
  ...
  const changeTrack = useCallback(
    ...
    [broadcast, loadTrack, prewarmTrack, preloadTrack, updateState]
  )
